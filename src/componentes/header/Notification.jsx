  ...
  return (
    <div className="relative inline-block">
      ...
      <button
        ...
        className="relative  right-5 md:right-0 notif  md:left-0 sm:left-24  p-3 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full hover:scale-110 transition-transform duration-300 shadow-lg"
      >
        {notifData.length > 0 && (

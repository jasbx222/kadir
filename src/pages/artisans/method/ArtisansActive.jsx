...
const ArtisansActive = () => {
  ...
  const filterData = data.filter(
    (artisan) =>
      (artisan.name.includes(search) ||
        artisan.service_name.includes(search)) &&
        ...
        {filterData.map((artisan, index) => (
          ...
          >
            ...
            <div className="p-4 text-center">
              ...
              />
              <h3 dir="ltr" className="text-lg font-bold mt-2">
                {artisan.name}
              </h3>
              <p className="text-gray-500">{artisan.service_name}</p>
              <p className="text-sm text-gray-400">
                <span className="text-green-300">{artisan.expire_date}</span>
              </p>
